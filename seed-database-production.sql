-- MINI PRIMA DATABASE SEEDING SCRIPT (PRODUCTION VERSION)
-- Comprehensive test data for E2E testing with realistic Brazilian legal practice data
-- This version works with existing Supabase auth constraints
...
-- 3. This script skips admin_users to avoid foreign key constraint errors
...
BEGIN
    RAISE NOTICE '=============================================================================';
    RAISE NOTICE 'MINI PRIMA DATABASE SEEDING COMPLETED SUCCESSFULLY! (PRODUCTION VERSION)';
    RAISE NOTICE '=============================================================================';
