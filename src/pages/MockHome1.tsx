...
const MockHome1: React.FC = () => {
  ...
  return (
    <div className="font-sans text-gray-900 bg-white">
      {/* Navigation */}
      <nav className="bg-[#021A38] shadow-sm fixed top-0 w-full z-10 text-white">
        <div className="container mx-auto flex items-center justify-between py-4">
          <div className="font-bold text-lg">D'Avila Reis Advogados</div>
          <div className="hidden md:flex space-x-8">
            <a href="#about" className="hover:text-[#D4AF37]">Sobre</a>
            <a href="#services" className="hover:text-[#D4AF37]">Áreas de Atuação</a>
            <a href="#team" className="hover:text-[#D4AF37]">Profissionais</a>
            <a href="#contact" className="hover:text-[#D4AF37]">Contato</a>
          </div>
          <Button onClick={() => navigate('/login')} className="bg-[#D4AF37] text-[#021A38]">
            Portal
          </Button>
        </div>
      </nav>
      ...
      <main className="pt-24">
        {/* Hero */}
        <section className="bg-gradient-to-r from-[#021A38] to-[#031f41] py-20 text-white">
          <div className="container mx-auto text-center">
            ...
            <Button onClick={() => navigate('/login')} className="bg-[#D4AF37] text-[#021A38] px-8 py-3">
              Acessar Portal
            </Button>
          </div>
        </section>
        ...
        <section id="contact" className="py-16 bg-gray-50">
          <div className="container mx-auto text-center space-y-4">
            ...
            <Button className="bg-[#D4AF37] text-[#021A38] px-6 py-3">Enviar Mensagem</Button>
          </div>
        </section>
      </main>
