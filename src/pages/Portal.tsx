    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800">
      ...
      <main className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="flex items-center justify-between">
                <CardTitle className="flex items-center space-x-3 text-lg text-white">
                  ...
                  <div>
                    ...
                    <div className="text-2xl font-bold text-blue-400 mt-1">{activeCases.length}</div>
                  </div>
                </CardTitle>
                <Button 
                  size="sm" 
              ...
              <div className="flex items-center justify-between">
                <CardTitle className="flex items-center space-x-3 text-lg text-white">
                  ...
                  <div>
                    ...
                    <div className="text-2xl font-bold text-green-400 mt-1">{documents.length}</div>
                  </div>
                </CardTitle>
                <Button 
                  size="sm" 
          ...
          {/* Chat com Equipe Jurídica - Merged with Messages/Notifications */}
          <Card className="bg-slate-800/50 border-slate-700 backdrop-blur-sm hover:bg-slate-800/70 transition-colors cursor-pointer" onClick={() => navigate('/portal/messages')}>
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2 mt-1">
                    ...
                    {unreadNotifications.length > 0 && (
                      <Badge className="bg-red-500 text-white text-xs">{unreadNotifications.length} novas</Badge>
                    )}
                  </div>
                </div>
              </CardTitle>
            ...
            <CardContent className="space-y-4">
              <p className="text-slate-300 text-sm">
                Comunique-se diretamente com nossa equipe jurídica e acompanhe suas notificações
              </p>
